...
#ifndef FLATBUFFERS_GENERATED_HELLO_MYGRPC_H_
#define FLATBUFFERS_GENERATED_HELLO_MYGRPC_H_
...
inline ::flatbuffers::Offset<HelloRequest> CreateHelloRequestDirect(
  ...
  return mygrpc::CreateHelloRequest(
      _fbb,
      name__);
}
...
inline ::flatbuffers::Offset<HelloReply> CreateHelloReplyDirect(
  ...
  return mygrpc::CreateHelloReply(
      _fbb,
      message__);
}
...
#endif  // FLATBUFFERS_GENERATED_HELLO_MYGRPC_H_
