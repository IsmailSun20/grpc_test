...
const uint32_t TableStruct_helloworld_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::helloworld::HelloReply, _impl_.id_),
};
...
const char descriptor_table_protodef_helloworld_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "oReply\022\017\n\007message\030\001 \001(\t\022\n\n\002id\030\002 \001(\t2G\n\007G"
  "reeter\022<\n\010SayHello\022\030.helloworld.HelloReq"
  "uest\032\026.helloworld.HelloReplyb\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_helloworld_2eproto = {
    false, false, 196, descriptor_table_protodef_helloworld_2eproto,
    "helloworld.proto",
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "helloworld.HelloRequest.id"));
        } else
          goto handle_unusual;
        continue;
      default:
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "helloworld.HelloReply.id"));
        } else
          goto handle_unusual;
        continue;
      default:
