...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void HelloRequest::set_id(ArgT0&& arg0, ArgT... args) {
...
inline std::string* HelloRequest::mutable_id() {
  ...
  // @@protoc_insertion_point(field_mutable:helloworld.HelloRequest.id)
  return _s;
}
...
inline std::string* HelloRequest::release_id() {
  // @@protoc_insertion_point(field_release:helloworld.HelloRequest.id)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:helloworld.HelloRequest.id)
}
...
inline const std::string& HelloReply::id() const {
  // @@protoc_insertion_point(field_get:helloworld.HelloReply.id)
  return _internal_id();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void HelloReply::set_id(ArgT0&& arg0, ArgT... args) {
 
 _impl_.id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:helloworld.HelloReply.id)
}
inline std::string* HelloReply::mutable_id() {
  std::string* _s = _internal_mutable_id();
  // @@protoc_insertion_point(field_mutable:helloworld.HelloReply.id)
  return _s;
}
inline const std::string& HelloReply::_internal_id() const {
  return _impl_.id_.Get();
}
inline void HelloReply::_internal_set_id(const std::string& value) {
  
  _impl_.id_.Set(value, GetArenaForAllocation());
}
inline std::string* HelloReply::_internal_mutable_id() {
  
  return _impl_.id_.Mutable(GetArenaForAllocation());
}
inline std::string* HelloReply::release_id() {
  // @@protoc_insertion_point(field_release:helloworld.HelloReply.id)
  return _impl_.id_.Release();
}
inline void HelloReply::set_allocated_id(std::string* id) {
  if (id != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:helloworld.HelloReply.id)
}
